...
SCAN = ROOT / "experimental" / "daq" / "2026-08-17" / "exp10-pulse-series"
...
fig.tight_layout()
for ext in ("png", "pdf"):
    fig.savefig(ROOT / "figures" / "thesis" / f"fig-power-linearity.{ext}",
                dpi=300, bbox_inches="tight")
print("wrote figures/thesis/fig-power-linearity.(png|pdf)")
...
fig.tight_layout()
for ext in ("png", "pdf"):
    fig.savefig(ROOT / "figures" / "thesis" /
                f"fig-pulse-characterization.{ext}", dpi=300,
                bbox_inches="tight")
print("wrote figures/thesis/fig-pulse-characterization.(png|pdf)")
